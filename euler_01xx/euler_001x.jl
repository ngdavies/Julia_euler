...
function euler_0019()
    ...
    sundays = 0
    # 1 Jan 1900 was a Monday, and 1900 is not a leap year
    # Process 1900 without counting Sundays to get the weekday for 1-1-1901
    day = 1
    for month in 1:12
...
function euler_0018(test)
    if test == true
        triangle_string = test_triangle_data
    else
